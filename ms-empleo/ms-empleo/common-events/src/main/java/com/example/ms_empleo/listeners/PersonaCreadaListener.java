...
public class PersonaCreadaListener {
    ...
    @KafkaListener(topics = "personas-topic", groupId = "empleo-group",containerFactory = "kafkaListenerContainerFactory")
    public void escucharPersonaCreada(PersonaCreadaEvent event) {
